...
-- если добавили в favorite - то добавляем сюда, иначе удаляем отсюда
...
-- Уникальность только для пар (user_id, algorithm_id), где rating NOT NULL
CREATE UNIQUE INDEX IF NOT EXISTS unique_rating_per_user_algorithm
    ON reviews (user_id, algorithm_id)
